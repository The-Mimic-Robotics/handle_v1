...
CHAR_UUID_JOY   = "9c661337-b499-497d-aa5b-0105316e6e22" # New Joystick UUID
...
def joy_notification_handler(sender, data):
    # Unpack 9 bytes: 2 little-endian floats and 1 unsigned char ('<2fB')
    joy_x, joy_y, sw = struct.unpack('<2fB', data)
    print(f"[JOY]   X: {joy_x:6.2f} | Y: {joy_y:6.2f} | SW: {sw}")
